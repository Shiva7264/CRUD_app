## EMPLOYE DETAILS MANAGEMENT CRUDE APP
from tkinter import*
...
def getData():
    if(enterId.get()==""):
       messagebox.showwarning("cannot Fetch","Employee Id is required!")
    else:
        myDB=mysql.connector.connect(host="localhost",user="root",passwd="root",database="employee")
        myCur=myDB.cursor()
...
def deleteData():
    if(enterId.get()==""):
       messagebox.showwarning("cannot Delete","Employee Id is required!")
    else:
        myDB=mysql.connector.connect(host="localhost",user="root",passwd="root",database="employee")
        myCur=myDB.cursor()
